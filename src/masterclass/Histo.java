...
/**
 * Responsible for general view of the program.
 * Reads dataset.txt files, plots histograms, fits gauss and polynomial functions, stores fitted parameters.
 */
...
public class Histo extends JFrame implements ActionListener {
    ...
    /**
     * Reads data for selected collision type.
     */
    public void read() {
        int i;
    ...
    /**
     * Plots histogram for selected collision type (datasetXX.txt file).
     * XX-numbers
     */
...
//		this.c1.setName("Invariant Mass spectra");
    ...
    static void FunctionFitter(double minGauss, double maxGaus, double minPoly,
        ...
        functionFitter.setRange(minPoly, maxPoly);// giving min-max ranges
    ...
    /**
     * Counts integral for background signal.
     */
    ...
    /**
     * Gets minimum range for Gauss fitting function.
     */
    ...
    /**
     * Sets maximum range for Gauss fitting function.
     */
